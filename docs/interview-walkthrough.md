...
1. Draw service map and ports (8080–8089); note embedded vs dedicated rebate/strategy.
2. Happy path: login (JWT) → stage activity → draw → award message → fulfillment / credit.
