...
| `DispatchCreditAwardTaskJob_DB1` | 5 | 0 | Award-credit outbox → account credit. **Money path**; bean also gated by `account.award-credit-outbox.enabled` (default false). |
| `DispatchCreditAwardTaskJob_DB2` | 6 | 0 | Same for db02. |
