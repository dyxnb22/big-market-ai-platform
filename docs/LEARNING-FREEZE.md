...
fulfillment :8087 -- optional remote award RPC in the default topology
```
...
| 后端契约与 smoke | HTTP 契约全过；microservices 21/21；API smoke 全过 |
...
- fresh 空卷、完整 secure overlay、8088/8089 独立部署未在本次审计动态验证。
