> **Archived (2026-06-12):** this document describes the pre-microservices module architecture and is no longer authoritative. See `docs/MICROSERVICES.md` for the current status.
