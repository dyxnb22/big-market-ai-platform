...
| Sub-batch | Title | Type | Notes |
|-----------|-------|------|-------|
| 7-A | Per-service table ownership matrix (extends §6 Boundary Matrix) | docs | Authoritative mapping; includes shard suffix coverage |
