...
| 7-A prep (AL-2/AL-3) | StrategyRepository account DAO removal | refactor | **Next batch** — remove `StrategyRepository` → `IRaffleActivityAccountDao` + `IRaffleActivityAccountDayDao`; route day/total quota reads through a strategy-context port boundary |
