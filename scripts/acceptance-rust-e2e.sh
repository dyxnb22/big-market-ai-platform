#!/usr/bin/env bash
# Playwright E2E against Rust stack (gateway :8080 + web :5173).
set -euo pipefail
ROOT="$(cd "$(dirname "$0")/.." && pwd)"
cd "$ROOT"

export E2E_STACK="${E2E_STACK:-rust}"
...
echo "Playwright listed ${listed} tests (E2E_STACK=$E2E_STACK)"
...
echo
echo "acceptance-rust-e2e PASS (${listed} tests x2)"
